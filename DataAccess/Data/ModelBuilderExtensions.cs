...
namespace DataAccess.Data
{
    public static class ModelBuilderExtensions
    {
        public static void SeedData(this ModelBuilder builder)
        {
            ...
            {
                new Film() {Id = 1, Name = "Fast&Furious", CategoryId = (int)Categories.Action, CompanyId = 5, Year = 2001, imageUrl = "https://wallpaperaccess.com/full/1494975.jpg"}
            });
            builder.Entity<Cinema_Hall>().HasData(new[]
            {
                new Cinema_Hall {Id = 1, Name = ""}
            });
